...
class MessageManager:
    ...
    def __init__(self, system_message: str = None, user: str = None, title: str = 'New conversation', conversation_file: str = None, path: str = 'conversations/'):
        """
        ...
        Raises:
            ...
            ValueError: If conversation_file is not a valid JSON file.
        """
        ...
        if conversation_file:
            if not conversation_file.endswith('.json'):
                raise ValueError("The conversation_file must be a valid JSON file with the extension '.json'")
